...
MEMORY
{
  ...
  /*I2C1      : org = 0x48070000 len = 0x00000300  CREGISTER=5 // Trying to link I2C register*/
/* WARNING: the next adress for I2C1 is not correct and actually point to i2c4 */
  I2C1      : org = 0x4807A000 len = 0x00000300  CREGISTER=5// /* Trying to link I2C register*/
...
SECTIONS {
  ...
  /*.shared_sect_name     > PRU_DMEM_0_1, PAGE 1*/
